...
const profilePicture = document.querySelector('.profile-card img');
...
profilePictureInput.addEventListener('change', function(event) {
    ...
    if (file) {
        ...
        // Cuando el archivo se carga, cambiar la imagen de perfil
        reader.onload = function(e) {
            profilePicture.src = e.target.result; // Establecer la nueva imagen en el perfil
        };
